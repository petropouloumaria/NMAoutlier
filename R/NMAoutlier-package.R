#' NMAoutlier: Brief overview of methodology for detection of influential and
#' outlying studies
#' 
#' @description
#' R package \bold{NMAoutlier} provides diagnostic methods to detect
#' influential and outlying studies in network meta-analysis.
#' 
#' @details
#' R package \bold{NMAoutlier} implements the forward search (FS)
#' algorithm for the detection of outlying and influential studies in
#' network meta-analysis (NMA) by Petropoulou et al. (2018). The
