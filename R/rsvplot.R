...
#' selected statistic throughout the random shift variance model fitted for selected/all studies
...
#'
#' @details
#' Plot of statistical measures for Random Shift Variance Model fitted for each study.
